  ...
  return (
    <main>
      <div className="page-head">
        ...
        <p className="page-sub">Buy cheap traffic, stretch attention, and push higher-value clicks out of the site.</p>
        <div className="pager-row" style={{ marginTop: "0.8rem" }}>
          <Link className="chip" href="/admin/traffic-tests">Simple Generator</Link>
      ...
      <div className="grid-list">
        ...
        <section className="card">
          ...
          <p className="meta" style={{ marginTop: "0.5rem" }}>
            {data.hasMeaningfulVolume
              ? "Decision is based on live volume."
              : "Not enough volume yet. Keep sending traffic before making a hard call."}
          </p>
        </section>
      </div>

      <section className="card" style={{ marginTop: "1rem" }}>
        <h2>Best Exit Targets</h2>
      ...
      <section className="card" style={{ marginTop: "1rem" }}>
        <h2>Top Pages By Exit Clicks</h2>
        <div style={{ marginTop: "0.8rem", display: "grid", gap: "0.5rem" }}>
      ...
      <section className="card" style={{ marginTop: "1rem" }}>
        <h2>Campaign Margin Breakdown</h2>
        <div style={{ marginTop: "0.8rem", display: "grid", gap: "0.5rem" }}>
